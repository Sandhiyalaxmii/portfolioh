...
const Hero = () => {
  ...
  <button
    ...
    className="px-3 py-1 text-xs md:px-4 md:py-1.5 md:text-sm font-medium
    rounded-full
  ...
  >
    Contact
      ...
      <motion.h1
        ...
        className="heading-font text-4xl md:text-5xl font-bold dark:text-white text-center">
  HI !! WELCOME TO MY <span className="text-violet-600 dark:text-violet-400">HIPPOCAMPUS</span>
      ...
      <motion.p
        ...
        animate={{ opacity: 1 }}
        transition={{ delay: 1 }}
        className="mt-4 text-xs md:text-sm text-gray-500 dark:text-gray-400 italic"
      >
